...
<div class="card">
    ...
    %>
    <img src="data:image/png;base64,<%=request.getAttribute("image")%>" style="width:100%">
...
<div class="row">
    <%
        ...
        request.setAttribute("files", new File((String) request.getAttribute("uploadUserPath")).listFiles());
    %>
    <div class="col-sm-4">
